...
(function($) {
    ...
    owl.owlCarousel({
        ...
        nav: true,
        dots: false,
        navText: ['<img src="/public/images/slider-images/nav/left-hover.png">', '<img src="/public/images/slider-images/nav/right-hover.png">'],
        mouseDrag: false,
        loop: true,
        ...
        if (typeof $map2.data('map-marker') !== 'undefined') {
            ...
            for (i; i < data.length; i++) {
                new google.maps.Marker({
                    ...
                    draggable: true,
                    // icon: '/public/images/map-marker-icon.png'
                });
            }
        }
    };
